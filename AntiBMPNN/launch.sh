sbatch -p yejin run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.1 --pdb_suffix _model_0.pdb --sampling_temp 0.2 --output_dir ./antibmpnn_output/bn0.1_raw_t0.2
sbatch -p yejin run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.1 --pdb_suffix _model_0.pdb --sampling_temp 0.4 --output_dir ./antibmpnn_output/bn0.1_raw_t0.4
sbatch -p yejin run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.1 --relaxed --sampling_temp 0.2 --output_dir ./antibmpnn_output/bn0.1_relaxed_t0.2
sbatch -p yejin run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.1 --relaxed --sampling_temp 0.4 --output_dir ./antibmpnn_output/bn0.1_relaxed_t0.4
sbatch -p yejin run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.0 --pdb_suffix _model_0.pdb --sampling_temp 0.2 --output_dir ./antibmpnn_output/bn0.0_raw_t0.2
sbatch -p yejin run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.0 --pdb_suffix _model_0.pdb --sampling_temp 0.4 --output_dir ./antibmpnn_output/bn0.0_raw_t0.4
sbatch -p yejin run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.0 --relaxed --sampling_temp 0.2 --output_dir ./antibmpnn_output/bn0.0_relaxed_t0.2
sbatch -p yejin run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.0 --relaxed --sampling_temp 0.4 --output_dir ./antibmpnn_output/bn0.0_relaxed_t0.4


sbatch -p yejin-lo run_antibmpnn_batch.sh --pdb_dir ../gen_trial_0/predictions --backbone_noise 0.0 --pdb_suffix _model_0.pdb --sampling_temp 0.2 --output_dir ./v2_antibmpnn_output/bn0.0_raw_t0.2
