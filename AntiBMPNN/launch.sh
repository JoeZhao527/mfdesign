...
sbatch -p yejin-lo run_antibmpnn_batch.sh --backbone_noise 0.0 --pdb_suffix _model_0.pdb --sampling_temp 0.2 --output_dir ./antibmpnn_output/bn0.0_raw_t0.2
sbatch -p yejin-lo run_antibmpnn_batch.sh --pdb_dir ../mfdesign_test_bagel_protein_boltz_base/predictions --backbone_noise 0.0 --pdb_suffix _model_0.pdb --sampling_temp 0.2 --output_dir ./antibmpnn_mfdesign_output/bn0.0_raw_t0.2
