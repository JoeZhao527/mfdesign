...
python evaluate/AbX_eval/our_relax_pdb.py \
        --data_dir 0128_out/inpaint/boltz_results_boltz_predicted_trail_0/predictions \
        --output_dir 0128_out/inpaint/boltz_results_boltz_predicted_trail_0/predictions \
...
python evaluate/AbX_eval/our_relax_pdb.py \
        ...
        --output_dir 0128_out/inpaint/boltz_results_boltz_predicted_trail_1/predictions \
        --split_json data/test_entry.json \
        --type boltz \
        --ref_dir ./data/test_entry_pdb_files \
        --test_yaml_dir data/test_yaml_dir/ab \
